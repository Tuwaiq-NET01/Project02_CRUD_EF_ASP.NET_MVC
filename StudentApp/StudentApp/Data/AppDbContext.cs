...
namespace StudentApp.Data
{
    public class AppDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Students
            modelBuilder.Entity<Student>().HasData(new Student { Id = 1, Name = "Rawabe alshduki", img = "https://previews.123rf.com/images/jemastock/jemastock1710/jemastock171012232/88397537-male-student-carrying-bag-happy-cartoon-icon-image-vector-illustration-design.jpg" }
            );
