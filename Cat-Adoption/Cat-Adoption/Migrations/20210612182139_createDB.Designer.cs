...
namespace Cat_Adoption.Migrations
{
    ...
    [Migration("20210612182139_createDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cat_Adoption.Models.AdopterModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cat_Adoption.Models.CatModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cat_Adoption.Models.LocationModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cat_Adoption.Models.OwnerModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cat_Adoption.Models.CatModel", b =>
                {
                    b.HasOne("Cat_Adoption.Models.AdopterModel", "Adopter")
                        .WithMany("cats")
                        .HasForeignKey("AdopterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cat_Adoption.Models.LocationModel", "Location")
                        .WithOne("cat")
                        .HasForeignKey("Cat_Adoption.Models.CatModel", "LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cat_Adoption.Models.OwnerModel", "Owner")
                        .WithMany("cats")
